            ...
            <div class="col-lg-4">
                <div class="form-group">
                        ...
                        <select class="form-select form-control-user @error('cityId') is-invalid @enderror"
                            name="cityId" id="cityId" style="padding:11px;border:1px solid #D1D3E2;font-size:15px;"
            ...
            <div class="col-lg-4">
                    <div class="form-group">
                            ...
                            <select class="form-select form-control-user @error('hospitalTypeId') is-invalid @enderror"
                                name="hospitalTypeId" id="hospitalTypeId" style="padding:11px;border:1px solid #D1D3E2;font-size:15px;"
                                aria-label="Default select example">
            ...
            <div class="col-lg-4">
                <div class="form-group">
                        ...
                        <select class="form-select form-control-user @error('category') is-invalid @enderror"
                            name="category" id="category" style="padding:11px;border:1px solid #D1D3E2;font-size:15px;"
                             aria-label="Default select example">
