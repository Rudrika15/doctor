...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="frm" action="{{route('admin.facility.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <img src="{{url('/facility/default.jpg')}}" alt="{{__('main image')}}" id="img1" style='min-height:100px;min-width:100px;max-height:100px;max-width:100px'>
                </div>
