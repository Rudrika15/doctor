...
<style>
    body {
        ...
        background-image: linear-gradient(blue 40%,white);
    }
    .form-div{   
...
<body >
    <div class="container text-center pt-5">
        <div class="d-flex justify-content-center mt-5 ">
            <div class="card w-50 mt-5 mb-5 shadow-lg p-3 mb-5 bg-body rounded form-div">
                <div class="card-body ">
                    <form method="POST" action="{{route('visitor.storeVisitorsDetailForDoctorDetail') }}">
                        @csrf
                        <div>
